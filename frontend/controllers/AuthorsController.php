...
class AuthorsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $author_email = isset($postDetails['Authors']['author_email']) ? $postDetails['Authors']['author_email'] : '';
            $author_pass = isset($postDetails['Authors']['author_password']) ? $postDetails['Authors']['author_password'] : '';
            $model->author_email = $author_email;
            $model->author_password = Yii::$app->security->generatePasswordHash($author_pass);
